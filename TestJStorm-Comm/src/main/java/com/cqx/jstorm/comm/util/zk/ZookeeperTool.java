...
public class ZookeeperTool implements Closeable {
     ...
     * @return
     */
    public static synchronized ZookeeperTool getInstance() {
        int cnt = 10;
     ...
     * @return
     */
    public static synchronized ZookeeperTool getNewInstance(String connectString, String root, WatcherCallBack watcher) {
    ...
    public static synchronized void init(String connectString, String root, WatcherCallBack watcher) {
        if (connectString != null) {
            if (zookeeperTool == null) {
                zookeeperTool = new ZookeeperTool(connectString);
